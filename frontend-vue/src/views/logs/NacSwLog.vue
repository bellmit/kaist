...
export default {
  methods: {
    async query() {
      ...
      let { data } = await this.$http.get("log_nac_sw", { params });
      ...
      table: {
        headers: [
          ...
          { text: "부서", value: "dept_name", sortable: false,
            align: "center" },
          { text: "프로그램명", value: "sw_name", sortable: false,
            align: "center" },
          { text: "버전", value: "sw_version", sortable: false,
            align: "center" },
          { text: "설치일자", value: "sw_install_date", sortable: false,
            align: "center" },
        ],
        loading: false,
        total: 0,
