                ...
                <abl-document ref="0" class="abl-page" :class="{active: active === 0}">
                    ...
                    <div class="abl-doc-body">
                        <table class="abl-table-title">
                            ...
                            <tr>
                                <th >사업명</th>
                                <td ><input type="text" disabled placeholder="사업명" class="abl-input" v-model="report_objs.dept_name"></td>
                            </tr>
                            <tr>
                                <th >사업 수행 업체명</th>
                                <td ></td>
                    ...
                    <div class="abl-doc-body">
                        <table class="abl-table">
                            ...
                            <tr>
                                <th class="s-h" colspan="2">점검대상 PC(총 반입PC)</th>
                                <td colspan="2"><input type="text" placeholder="명" class="abl-input" v-model="self_diagnosis_data.dept_total_count"></td>
                                <th class="s-h" colspan="3">점검 PC</th>
                                <td colspan="2"><input type="text" placeholder="명" class="abl-input" v-model="self_diagnosis_data.diagnosis_total_count"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="s-h" colspan="2" rowspan="5">진단불가자</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(1.1.1) ~ (1.1.9) 용역업체 직원 PC 내PC지키미 진단 항목 점검</th>
                            ...
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(1.2.1) 용역업체 직원 PC 매체제어 에이전트 설치 </th>
                            ...
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(1.2.2) 용역업체 직원 PC 물리적 포트 차단 </th>
                            ...
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1"> (2.1.1) ~ (2.1.2) 인터넷망 PC 자료 보안</th>
                            ...
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(3.1.1.) 개인정보 파일 암호화 또는 삭제 조치</th>
                                <td colspan="1"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_mypc_result"></td>
                                <td colspan="3"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_mypc_remark"></td>
                            </tr>
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(4.1.1) 용역업체 직원의 계정을 하나의 그룹으로 등록하고 계정별로 정보시스템 접근권한 부여 </th>
                                <td colspan="1"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_program_result"></td>
                                <td colspan="3"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_program_remark"></td>
                            </tr>
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(4.1.2) 접근권한 불필요 시 신속 해지하거나 폐기 </th>
                                <td colspan="1"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_ipc_result"></td>
                                <td colspan="3"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_ipc_remark"></td>
                            </tr>
                            <tr>
                                <th class="s-h p-left" colspan="4" rowspan="1">(5) 물리적 보안장치(시건장치) 설치 여부</th>
                                <td colspan="1"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_file_result"></td>
                                <td colspan="3"><input type="text" placeholder="" class="abl-input" v-model="self_diagnosis_data.diagnosis_file_remark"></td>
                            </tr>
                        </table>
                    ...
                    <div class="abl-doc-title-sub">
                        <div class="title-text">
                            2. 용역업체 직원 점검 확인서(용역업체 직원 서명받아 스캔하여 첨부)

                        </div>
                    </div>
                    <table class="abl-table">
                        <colgroup>
                            <col style="width:3.69%" />
                            <col style="width:4.69%" />
                            <col style="width:4.69%" />
                            <col style="width:4.69%" />
                            <col style="width:14.69%" />
                        ...
                        <tr>
                            <th class="s-h" colspan="13">사이버보안진단 용역업체 점검 확인서</th>
                        </tr>
                        <tr>
                            <th class="s-h-r" colspan="13">범례 : 안전 O , 취약 X, 점검불가 로 표기</th>
                        </tr>
                        <tr>
                            <th class="s-h" colspan="3">점검일</th>
                            <td colspan="10"><input type="text" placeholder="" class="abl-input" v-model="form.application.company"></td>
                        </tr>
                        <tr>
                            <th rowspan="5" colspan="1">No</th>
                        </tr>
                        <tr>
                            <th rowspan="4" colspan="1">사업명</th>
                            <th rowspan="4" colspan="1">성명</th>
                            <th rowspan="4" colspan="1">망구분</th>
                            <th rowspan="1" colspan="7">점검 항목</th>
                            <th rowspan="4" colspan="1">확인 및  서명</th>
                            <th rowspan="4" colspan="1">비고(특이사항)</th>
                        </tr>

                        <tr>
                            <th rowspan="1" colspan="3">PC보안</th>
                            <th rowspan="1" colspan="2">2. 자료 보안</th>
                            <th rowspan="1" colspan="1">3. 개인정보파일 보유 여부</th>
                            <th rowspan="1" colspan="1">5. 물리적 보안장치</th>
                        </tr>
                        <tr>
                            <th rowspan="1" colspan="1">(1.1) 내pc 지키미</th>
                            <th rowspan="1" colspan="2">(1.2) 매체제어 프로그램 설치</th>
                            <th rowspan="1" colspan="2">(2.1) 인터넷망 PC</th>
                            <th rowspan="1" colspan="1">(3.1) 개인정보 파일 보호</th>
                            <th rowspan="2" colspan="1">시건장치(켄싱턴락) 설치 여부</th>
                        </tr>
                        <tr>
                            <th rowspan="1" colspan="1">(1.1.1) ~ (1.1.10)</th>
                            <th rowspan="1" colspan="1">(1.2.1)</th>
                            <th rowspan="1" colspan="1">(1.2.2)</th>
                            <th rowspan="1" colspan="1">(2.1.1)</th>
                            <th rowspan="1" colspan="1">(2.1.2)</th>
                            <th rowspan="1" colspan="1">(3.1.1) </th>
                        </tr>
                        <tr>
                            <th rowspan="1" colspan="1">1</th>
                            <th rowspan="13" colspan="1"></th>
                    ...
                    <table class="abl-table">
                        ...
                        <tr>
                            <th class="s-h" colspan="7">계정 신청 현황</th>
                        </tr>
                        <tr>
                            <th rowspan="1" colspan="1">신청 일자</th>
                            <th rowspan="1" colspan="1">만료 일자</th>
                            <th rowspan="1" colspan="1">시스템명</th>
                            <th rowspan="1" colspan="1">신청 계정(ID)</th>
                            <th rowspan="1" colspan="1">사용자 IP</th>
                            <th rowspan="1" colspan="1">사용자 명</th>
                            <th rowspan="1" colspan="1">비고</th>
                        </tr>

                        <tr>
                            <th rowspan="1" colspan="1">{{empty}}</th>
                            <th rowspan="1" colspan="1"></th>
                            <th rowspan="1" colspan="1"></th>
                            <th rowspan="1" colspan="1"></th>
                            <th rowspan="1" colspan="1"></th>
